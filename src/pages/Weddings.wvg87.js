/**
 * Wedding (/weddings) — feeds <dkdjs-page page="weddings">.
 *
 * Canvas setup:
 ...
 *   ID          dkdjsPage
 *
 * Copy comes from SERVICES.weddings in public/content.js. The same strings build
...
function applySeo(el) {
  try {
    ...
    console.error('[weddings] seoMarkup failed', err);
  }
  try {
    ...
    console.error('[weddings] setStructuredData failed', err);
  }
}
