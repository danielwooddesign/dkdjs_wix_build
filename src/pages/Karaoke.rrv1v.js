/**
 * Karaoke (/karaoke) — feeds <dkdjs-page page="karaoke">.
 *
 * Canvas setup:
 ...
 *   ID          dkdjsPage
 *
 * Copy comes from SERVICES.karaoke in public/content.js. The same strings build
...
function applySeo(el) {
  try {
    ...
    console.error('[karaoke] seoMarkup failed', err);
  }
  try {
    ...
    console.error('[karaoke] setStructuredData failed', err);
  }
}
