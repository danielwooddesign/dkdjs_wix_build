 ...
 *
 * Rename this file to match the real page file Wix generates
 * (src/pages/Packages.<id>.js) and paste the contents in.
 *
 * The element on the page needs ID #dkdjsPage, tag name dkdjs-page, and the
 * attribute  page = packages  set in the element's Set Attributes panel.
 */
